...
Programming makes your science: 
...
and statistics. It has a huge user-community and is highly extensible, with 
thousands of packages that add extra functionality at the official Comprehensive
R Archive Network. For almost anything you want to do, there is an R package to 
help. In short, for most social scientists, it is the best tool to organize, 
...
- Console
    - The R console is where code is run
        - The console in RStudio is the same as if typed in `R` in your command 
        line
    - When you start RStudio, you'll see a bunch of information, followed by a 
    ">" and a blinking cursor. This is a "Read, evaluate, print loop". It's 
    highly interactive: You can type in commands and R will execute them and 
    print the result.
...
- Script
    ...
    - cmd/ctrl-enter executes the line the cursor is on by copying that line and 
